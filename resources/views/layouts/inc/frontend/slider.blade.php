<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="false">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ asset('/uploads/carousel/banner_1.jpg') }}" class="d-block w-100" alt="...">
        ...
        <div class="carousel-item">
            <img src="{{ asset('/uploads/carousel/banner_2.jpg') }}" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
                <div class="custom-carousel-content">
                    <h1>
        ...
        <div class="carousel-item">
            <img src="{{ asset('/uploads/carousel/banner_5.jpg') }}" class="d-block w-100" alt="...">
            <div class="carousel-caption d-none d-md-block">
                <div class="custom-carousel-content">
                    <h1>
