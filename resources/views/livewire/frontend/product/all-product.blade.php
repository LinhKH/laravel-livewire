                ...
                <div class="col-md-3">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <label class="form-check-label d-block py-2">
                                <input type="checkbox" wire:model.change="categoryCheck" value="{{ $category->id }}"
                                    class="form-check-input">
                                <i class="input-helper"></i> {{ $category->name }}</label>
                        ...
                        <div class="card-body">
                            ...
                            <label class="form-check-label d-block py-2">
                                <input type="checkbox" wire:model.change="colorCheck" value="{{ $color->id }}"
                                    class="form-check-input">
                                    <span class="colour-label colour-colorDisplay" style="background-color: {{ $color->code }};"></span>
                                {{ $color->name }}</label>
                    ...
                    <div class="card mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <label class="form-check-label d-block py-2">
                                <input type="radio" wire:model.change="priceCheck" value="high-to-low"
                                    class="form-check-input">
                                <i class="input-helper"></i> High to low</label>
                            <label class="form-check-label d-block py-2">
                                <input type="radio" wire:model.change="priceCheck" value="low-to-high"
                                    class="form-check-input">
                        ...
                        <div class="col-md-4">
                            <div class="product-card">
                                ...
                                <div class="product-card-body">
                                    ...
                                    <div class="mt-2">
                                        <a href="" wire:click='addToCard({{ $product->id }})' class="btn btn1">Add To Cart</a>
