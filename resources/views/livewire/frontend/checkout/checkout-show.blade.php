                        ...
                        <form action="" method="POST">
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="text" wire:model='full_name' name="full_name" class="form-control" placeholder="Enter Full Name" />
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="number" wire:model='pincode' name="pincode" class="form-control" placeholder="Enter Pin-code" />
                                    ...
                                    <div class="d-md-flex align-items-start">
                                        ...
                                        <div class="tab-content col-md-9" id="v-pills-tabContent">
                                            <div class="tab-pane active show fade" id="cashOnDeliveryTab" role="tabpanel"
                                                ...
                                                <hr />
                                                <button wire:click='codOrder' type="button" class="btn btn-primary">Place Order (Cash on
                                                    Delivery)</button>
