            ...
            <div class="row">
                ...
                <div class="col-md-5 my-auto">
                    <ul class="nav justify-content-end">
                        ...
                        <li class="nav-item">
                            <a wire:navigate class="nav-link" href="{{ url('/carts') }}">
                                <i class="fa fa-shopping-cart"></i> Cart (<livewire:frontend.cart.cart-count>)
                            </a>
                        </li>
                        <li class="nav-item">
                            <a wire:navigate class="nav-link" href="{{ url('/wishlists') }}">
                                <i class="fa fa-heart"></i> Wishlist (<livewire:frontend.wish-list.wish-list-count>)
                            </a>
                        </li>
                        @if (auth()->check())
